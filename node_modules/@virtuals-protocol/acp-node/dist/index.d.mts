...
declare class AcpContractClient extends BaseAcpContractClient {
    ...
    get sessionKeyClient(): {
        ...
        type: string;
        uid: string;
        buildUserOperation: (args: _aa_sdk_core.BuildUserOperationParameters<_account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>, _aa_sdk_core.UserOperationContext | undefined>) => Promise<_aa_sdk_core.UserOperationStruct<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>>;
        buildUserOperationFromTx: (args: viem.SendTransactionParameters<viem.Chain, _account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>>, overrides?: _aa_sdk_core.UserOperationOverrides<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>> | undefined, context?: _aa_sdk_core.UserOperationContext | undefined) => Promise<_aa_sdk_core.UserOperationStruct<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>>;
        buildUserOperationFromTxs: (args: _aa_sdk_core.BuildTransactionParameters<_account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>, _aa_sdk_core.UserOperationContext | undefined>) => Promise<_aa_sdk_core.BuildUserOperationFromTransactionsResult<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>>;
        ...
        extend: <const client extends {
            ...
            Parameters: [filterId: viem.Quantity];
            ReturnType: boolean;
        }], { [K in keyof client]: client[K]; } & Record<string, unknown> & {
            buildUserOperation: (args: _aa_sdk_core.BuildUserOperationParameters<_account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>, _aa_sdk_core.UserOperationContext | undefined>) => Promise<_aa_sdk_core.UserOperationStruct<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>>;
            buildUserOperationFromTx: (args: viem.SendTransactionParameters<viem.Chain, _account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>>, overrides?: _aa_sdk_core.UserOperationOverrides<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>> | undefined, context?: _aa_sdk_core.UserOperationContext | undefined) => Promise<_aa_sdk_core.UserOperationStruct<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>>;
            buildUserOperationFromTxs: (args: _aa_sdk_core.BuildTransactionParameters<_account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>, _aa_sdk_core.UserOperationContext | undefined>) => Promise<_aa_sdk_core.BuildUserOperationFromTransactionsResult<keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>>;
            checkGasSponsorshipEligibility: <TContext extends _aa_sdk_core.UserOperationContext | undefined = _aa_sdk_core.UserOperationContext | undefined, TEntryPointVersion extends keyof _aa_sdk_core.EntryPointRegistryBase<unknown> = keyof _aa_sdk_core.EntryPointRegistryBase<unknown>>(args: _aa_sdk_core.SendUserOperationParameters<_account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>, TContext>) => Promise<_aa_sdk_core_dist_types_actions_smartAccount_checkGasSponsorshipEligibility.CheckGasSponsorshipEligibilityResult<_account_kit_smart_contracts.ModularAccountV2<SmartAccountSigner<any>>, TEntryPointVersion>>;
